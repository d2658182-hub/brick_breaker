...
Can you clear every wall and become the ultimate breaker?

## Controls

**Desktop**
- **Move mouse left / right** to slide the paddle
- **Click** to launch the ball at the start and after losing a life
- **P** or **Pause button** to pause / resume
- **M** to mute / unmute
- **F** for fullscreen (when available)

**Mobile / Tablet**
- **Drag finger left / right** across the bottom to move the paddle
- **Tap** to launch the ball
- **Tap Pause icon** to pause / resume
- **Tap Sound icon** to mute / unmute
